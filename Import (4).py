...
################################################################
# Liste des projets dans JIRA
# Structure :
#         1 - Nom Application dans HP Agile manager - correspondant au champs APPLICATION dans le csv fname
#         2 - Nom projet JIRA - Inutilisé
#         3 - Clé projet JIRA - Utilisé pour la génération des clés JIRA, la nomenclature des fichiers et répertoires
################################################################
listproj=[]

listproj.append(["3D","3D Distributeur De Données","DDD","software"])
listproj.append(["AJU-Annuaire Juridique","AJU - Annuaire Juridique","AJU","software"])
listproj.append(["AML COSI","AML Cosi","AMLC","software"])
listproj.append(["BASYLIQ","BASYLIQ","BSLQ","software"])
listproj.append(["BASYLIQ-GHOSTCAT","BASYLIQ-GHOSTCAT","BSLQGC","software"])
listproj.append(["Benchmark","Benchmark","BENCH","software"])
listproj.append(["BI Achats","BI Achats","BIA","software"])
listproj.append(["BLR-H2R-MA-Support","BLR-H2R-MA-Support","BHMS","software"])
listproj.append(["BPT","Balance des Paiements","BPT","software"])
listproj.append(["CDE Conduite du Changement","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE Métrologie","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE Normes & méthodes","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE SOFA Déploiement continu","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE SOFA Fast Provisionning","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE SOFA Intégration continue","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["CDE Testing","CDE SOFA Continuous Delivery","CDE5","software"])
listproj.append(["Cesta -PNB","CPN CESTA PNB","CPN","software"])
listproj.append(["Consolidation des liasses","Consolidation des Liasses","CDL","software"])
listproj.append(["CP2","CP2_Old","CP2_OLD","software"])
listproj.append(["CP2 target","CP2T","CP2T","software"])
listproj.append(["CRS - Reporting Statement","CRS - Reporting Statement","CRS","software"])
listproj.append(["DATT","DATT","DATT","software"])
listproj.append(["DNSG","DNSG","DNSG","software"])
listproj.append(["edoc-STP","EDOC-STP","EDOCSTP","software"])
listproj.append(["eNews","eNews","SHPENW","software"])
listproj.append(["Ereca","Ereca","ERC","software"])
listproj.append(["FPM -  BGD - Platform","FPM - BGD - Platform","FPMBGD","software"])
listproj.append(["FPM - DC","FPM - DC","FPMDC","software"])
listproj.append(["FPM - DCBUD","FPM - DCBUD","FPMDCBUD","software"])
listproj.append(["FPM - DEFI","FPM – DEFI","FPMDEFI","software"])
listproj.append(["FPM - DEPSI","FPM - DEPSI","FPMDEPSI","software"])
listproj.append(["FPM - DEPSI-N2","FPM - DEPSI-N2","FPMDEPSIN2","software"])
listproj.append(["FPM - GPTool","FPM - GP TOOL","FPMGPTOOL","software"])
listproj.append(["FPM - GRP","FPM - GRP","FPMGRP","software"])
listproj.append(["FPM - LAND","FPM - LAND","FPMLAND","software"])
listproj.append(["FPM - OIG","FPM - OIG board","FPMOIG","software"])
listproj.append(["FPM - PERF","FPM - PERF","FPMPERF","software"])
listproj.append(["IFRS9 - Repooling","IFRS9 - Repooling","IFRS9REP","software"])
listproj.append(["IMPACT","IMPACT","IMPACT","software"])
listproj.append(["MADIIMAR","MADIIMAR","MADIIMAR","software"])
listproj.append(["Master cde simple","Master cde simple","MCS","software"])
listproj.append(["Mostra","Mostra","MOS","software"])
listproj.append(["MTA - Manage Team Activity","MTA - Manage Team Activity","MTA","software"])
listproj.append(["My Societe Generale","My Societe Generale","MYSG","software"])
listproj.append(["NEWBIM - ALLOCATION FRA","NEWBIM - ALLOCATION FRA","NBAF","software"])
listproj.append(["NEWBIM - MSBI & DECO NEWBIM CONSO","NEWBIM - MSBI & DECO NEWBIM CONSO","NBMDNC","software"])
listproj.append(["NEWBIM - NBL_FRA MSBI","NEWBIM - NBL_FRA MSBI","NBNFM","software"])
listproj.append(["NEWBIM - PNB SPA","NEWBIM - PNB SPA","NBPS","software"])
listproj.append(["NOB - GAP Analysis","NOB - GAP Analysis","NOBGAP","software"])
listproj.append(["NOB-Normative Bank","NOB-Normative Bank","NOBNorm","software"])
listproj.append(["Nosica","NOSICA","NOS","software"])
listproj.append(["ODE","ODE outil de Restitution d'ERECA","ODE","software"])
listproj.append(["People","Release People","People","software"])
listproj.append(["PGR","My Societe Generale","MYSG","software"])
listproj.append(["Rapsody","Rapsody","RAP","software"])
listproj.append(["RAVEL","T0155_RAVEL","RAVEL","software"])
listproj.append(["RBO","RBO","RBO","software"])
listproj.append(["RCT - Referentiel Communautaire des Tiers","RCT - Referentiel Communautaire des Tiers","RCT","software"])
listproj.append(["Rémunération","Remuneration","REMU","software"])
listproj.append(["Reporting Juridique","Reporting Juridique","RJ","software"])
listproj.append(["RITEL - Refacturation, Infrastructure & Telecom","RITEL - Refacturation, Infrastructure & Telecom","RITEL","software"])
listproj.append(["SABLE","SABLE","SAB","software"])
listproj.append(["SAFIR Business Transfo","SAFIR Business Transfo","SAFIRBT","software"])
listproj.append(["Sakkarah","Sakkarah board","SAK","software"])
listproj.append(["SIGIM","SIGIM","SGM","software"])
listproj.append(["SSD  Significant Shareholding Disclosure","SSD  Significant Shareholding Disclosure","SSD","software"])
listproj.append(["STARWORLD","STARWORLD","STARWORLD","software"])
listproj.append(["UAS","UAS","UAS","software"])
listproj.append(["Vizir","Vizir","VZR","software"])
listproj.append(["Watchlist","Watchlist","WAT","software"])
listproj.append(["SEA (IRT 2841)","SEA","SEA","software"])
listproj.append(["ERH","ERH","ERH","software"])
listproj.append(["SAFE","SAFE","SAFE","software"])
...
def jiraifyKeys(obj, featuresList):
    ...
    for key in obj.keys():
        ...
        #    del obj[key]
            ...
            if key == "description":
                if obj[key] != None:
                    obj[key] = strip_tags(parser.unescape(obj[key]))
            ...
            if key in ("feature_type", "type", "issueType"):
                ...
                if obj[new_key] == "feature" or obj[new_key] == "Epic":
                    ...
                    if obj.has_key("name"):
                        # customFieldValuesToAdd.append({"fieldName": "Epic Name", "fieldType": "com.pyxis.greenhopper.jira:gh-epic-label", "searcherType": "com.pyxis.greenhopper.jira:gh-epic-label-searcher", "value": unicode(obj["name"])})
            ...
            if key == "feature_id":
                if obj[key] is not None:
                    ...
                    # newValue = {"fieldName": "Epic Link", "fieldType": "com.pyxis.greenhopper.jira:gh-epic-link", "value": unicode(featureName)}
            ...
            if key == "id":
                ...
                if obj.has_key("item_id"):
                    ...
                    with open("idpair.json", "a") as idPairFile:
                        idPairFile.write(json.dumps(idPair, ensure_ascii=True)+", ")
...
def backlog_itemsFunction(access_token):
    ...
    while totalResults > currentResults: 
        ...
        # if offset == 491 or offset == 492 or offset == 493 or offset == 494 or offset == 495 or offset == 496 or offset == 497 or offset == 498 or offset == 499 or offset == 500 or offset == 508 or offset == 507 :
        # offsetUrl = 'https://agilemanager-lon.saas.hp.com/agm/api/workspaces/1000/backlog_items?query=%22application_id%3D' + str(application_id) + '%22&&&offset=' + str(offset) + '&limit=' + str(limit)
        ...
        print 'Backlog Application Pass number ' + str(numberOfPasses) + ' : ' + str(offset) + ' - ' + str(offset + 100) + '; total = ' + str(currentResults)
...
def createVersions(versionsList):
    ...
    for version in versionsList:
        ...
        if version["description"] != None:
            releaseDescription = strip_tags(parser.unescape(version["description"]))
        newVersion = {"name" : version["name"],
        "released" : released,
		"archived" : False,
		"releaseDate" : version["end_date"],
		# "description": unicode(releaseDescription)}
...
with io.open(projectKey + '_data.json', 'w', encoding='utf-8') as f:
    # f.write(unicode(json.dumps(finalExportData, ensure_ascii=False)))
